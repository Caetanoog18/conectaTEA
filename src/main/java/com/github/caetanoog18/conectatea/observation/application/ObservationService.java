...
public class ObservationService {
    ...
    public ObservationService(ObservationRepository observationRepository, ObservationAccessService accessService) {
    ...
    public ObservationResponse findById(UUID studentId, UUID observationId, String authenticatedEmail) {
        ...
        Observation observation = observationRepository
                .findByIdAndStudent_IdAndPurpose(observationId, studentId, access.purpose())
